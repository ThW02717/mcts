...
class Board(object):
    ...
    def current_state(self):
        ...
        state[3, :, :] is all 0 -> player 1 is playing ; 1 -> player 2 is playing
        state[0, :, :] if a element is 1 -> current player has a piece on the location
        state[1, :, :] if a element is 1 -> opponent player has a piece on the location
        state[2, :, :] last move location
        """
